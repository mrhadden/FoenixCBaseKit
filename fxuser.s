...
;#include "fxuser.h"
	...
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOSv1\src\fxtypes.h",0
	.line	708
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOSv1\src\fxuser.h",11
	.line	24
...
zp_1	set	0
	...
	.sym	kcallId,4,16,6,16
	.sym	kcallArg,6,129,6,32
	.sym	ppResult,10,1153,6,32
	jsl	~~InitFXTools
	sta	<L7+zp_1
	stx	<L7+zp_1+2
	.line	28
...
L7	equ	1
	...
	data
L1:
	db	$5F,$5F,$6B,$65,$72,$6E,$65,$6C,$5F,$63,$61,$6C,$6C,$3A,$3A
	db	$45,$4E,$54,$45,$52,$0D,$0A,$00,$5F,$5F,$6B,$65,$72,$6E,$65
	db	$6C,$5F,$63,$61,$6C,$6C,$3A,$3A,$45,$58,$49,$54,$0D,$0A,$00
	ends
;
;
;
...
;	zp->kernelFunctionCallParameter = (LPVOID)deviceName;
	.line	87
	lda	<L12+deviceName_0
	ldy	#$30
	sta	[<L13+zp_1],Y
	lda	<L12+deviceName_0+2
	ldy	#$32
	sta	[<L13+zp_1],Y
;
;#ifdef __ORCAC__
...
;{
	...
	.line	110
	code
	xdef	~~user_debug_string_com1
	func
	.function	110
~~user_debug_string_com1:
	longa	on
	longi	on
	tsc
	sec
...
ptr_1	set	0
	...
	lda	<L21+debugString_0
	sta	<L22+ptr_1
	lda	<L21+debugString_0+2
	sta	<L22+ptr_1+2
	.line	112
L10003:
	lda	[<L22+ptr_1]
...
;
	.line	121
	.file	"G:\devprojects\c256Foenix\fxos\FXOSWorkspace\FXOSv1\src\fxuser.c",109
	.sym	~~__kernel_call,~~__kernel_call,80,2,0
	.sym	~~user_debug_string_com1,~~user_debug_string_com1,65,2,0
	.sym	~~GetDirectory,~~GetDirectory,65,2,0
	.sym	~~DebugOut,~~DebugOut,65,2,0
	.sym	DEBUGOUT,0,641,14,32
	.sym	~~InitFXTools,~~InitFXTools,1089,2,32
